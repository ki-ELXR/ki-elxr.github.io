...
---
<!-- To embed photos from google drive, make the photo viewable by anyone on google drive.

Then copy the photo id from the url
https://drive.google.com/file/d/1UViU9Czm5C4b4N9ioehtw3ujcTRoL4N1/view?usp=sharing where the photo id = 1UViU9Czm5C4b4N9ioehtw3ujcTRoL4N1

Copy the html tags down below and paste the id in the href and src tags. The src tag should have the =s400 at the end so that way it is scaled down on the actual page.

Add an id tag after the src tag.

Group all the photos together in rows. Vertical images can be a row of 3, while horizontal images can be a row of 2. 
 -->
...
<div class="venobox-group" style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 15px;">
  ...
  <a class="venobox" data-gall="myGallery" href="https://lh3.googleusercontent.com/d/1WvTLiX74o5ePTVV1YQCKRPLQNn6vB3dq" id="portfolio-11">
  <img src="https://lh3.googleusercontent.com/d/1WvTLiX74o5ePTVV1YQCKRPLQNn6vB3dq=s400"  />
  </a>
</div>
...
<div class="venobox-group" style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 15px;">
  ...
  <a class="venobox" data-gall="myGallery" href="https://lh3.googleusercontent.com/d/1crlqxtRdVCrKmigVYPvbt_Hi54HHVJh1" id="portfolio-16">
